...
class BlackJack {
  ...
  public static int getTotal(String[] hand){
    ...
    for(int i = 0; i < hand.length; i++){
      ...
      String newValue = hand[i].substring(1);
      if(newValue.equals("J")|| newValue.equals("Q") || newValue.equals("A") || newValue.equals("K")){
        if(newValue.equals("A")){
          
          //for(int j = 0; j < hand.length; j++){
            //newValue = hand[j].substring(1);
            if(newValue.equals("A")){
              newValue = "11";
            }
            //else{
